...
def gitOpsUrl="gitlab.dspace.kt.co.kr/icis/sa/${GIT_OPS_NAME}.git"
def gitLabOrigin="gitlab.dspace.kt.co.kr/icis/sa/${PROJECT_NAME}.git
...
def getTag() 
	...
	if(gitBranch == 'dev' || gitBranch == 'olv') {
